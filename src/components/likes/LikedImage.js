        ...
        <div className="liked-image-container">
            <div className="image-delete">
                <button className="image-delete-button">
                    <svg className="image-delete-button-image" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <img className="liked-image" src={image.image.url} alt='dog'></img>
        </div>
    );
}
